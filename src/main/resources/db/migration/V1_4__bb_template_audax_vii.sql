...
VALUES ('Silicon Valley Bank (Audax Fund VII)', 'B', 'Investor List', 12, FALSE, 1, FALSE, FALSE, 0)
...
WITH t AS (
    ...
    WHERE template_name = 'Silicon Valley Bank (Audax Fund VII)' AND template_class = 'B'
)
