...
VALUES ('JP Morgan (AEP VII)', 'A', 'BB', 10, FALSE, 1, TRUE, TRUE, 9)
...
WITH t AS (
    ...
    WHERE template_name = 'JP Morgan (AEP VII)' AND template_class = 'A'
)
...
WITH tab AS (
    ...
    WHERE tmpl.template_name = 'JP Morgan (AEP VII)'
