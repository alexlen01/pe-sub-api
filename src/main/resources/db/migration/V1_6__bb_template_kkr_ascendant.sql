...
VALUES ('KKR Ascendant Fund / JP Morgan', 'A', 'Borrowing Base', 9, FALSE, 1, TRUE, FALSE, 9)
...
WITH t AS (
    ...
    WHERE template_name = 'KKR Ascendant Fund / JP Morgan' AND template_class = 'A'
)
...
WITH tab AS (
    ...
    WHERE tmpl.template_name = 'KKR Ascendant Fund / JP Morgan'
