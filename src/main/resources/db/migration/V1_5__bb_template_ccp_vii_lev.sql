...
VALUES ('Silicon Valley Bank (CCP VII Lev M & M)', 'C', 'Investor List', 6, FALSE, 1, TRUE, FALSE, 0)
...
WITH t AS (
    ...
    WHERE template_name = 'Silicon Valley Bank (CCP VII Lev M & M)' AND template_class = 'C'
)
...
WITH tab AS (
    ...
    WHERE tmpl.template_name = 'Silicon Valley Bank (CCP VII Lev M & M)'
